...
RUN echo "Building the $applicationName application"

COPY ./dist/apps/$applicationName/public ./public
# COPY ./docker-bootstrap.sh .
COPY ./dist/apps/$applicationName/next.config.js .
COPY ./dist/apps/$applicationName/.next ./.next
COPY ./package.json .
